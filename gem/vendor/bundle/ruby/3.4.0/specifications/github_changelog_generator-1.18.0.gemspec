...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<async>.freeze, [">= 1.25.0".freeze])
  s.add_runtime_dependency(%q<async-http-faraday>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<benchmark>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<faraday-http-cache>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<octokit>.freeze, ["~> 4.6".freeze])
  s.add_runtime_dependency(%q<rainbow>.freeze, [">= 2.2.1".freeze])
